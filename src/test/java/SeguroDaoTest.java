...
public class SeguroDaoTest {
    ...
    public void introducirSeguro() {
        ...
        Seguro seguroExistente = new Seguro("test01", "oscar", "gonzalez", "Strozzi",
                20, Sexo.Hombre, Boolean.FALSE, 0, Timestamp.valueOf("2021-05-02 04:04:05"), TipoSeguro.COCHE, Date.valueOf("2022-02-29"), Time.valueOf("12:05:30"), new char[]{'a','b','c'}, "comentario1");
    ...
    public void buscarSeguro() {
        Seguro seguro = new Seguro(339, "test02", "Juan", "Pepe", "Aler",
                19, Sexo.Mujer, true, 2, Timestamp.valueOf("2021-07-02 04:04:05"), TipoSeguro.MOTO,Date.valueOf("2022-02-29"), Time.valueOf("12:05:30"), new char[]{'a','b','c'}, "comentario1");
    ...
    @Test
    @DisplayName("Comprobar claves")
    void testClaves() {
        Seguro buscar=seguroDao.buscar(351);
        char[] array={'a','b','c'};
        Assertions.assertArrayEquals(array,buscar.getClaves(),"Las claves no coinciden");
    }

    @Test
    void testComentarios() {
        Seguro buscar=seguroDao.buscar(352);
        String comentario="Ejemplo Comentario 1";
        Assertions.assertEquals(comentario,buscar.getComentarios(),"Los comentarios no coinciden");
    }
}
